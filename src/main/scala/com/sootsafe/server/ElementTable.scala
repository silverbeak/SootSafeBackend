...
object ElementTable {
  ...
  val elements: Map[String, Element] = Map(
    ...
    "71-43-2" -> Element("Benzene", casNumber = "71-43-2", egNumber = "200-753-7", RDT = 2.70, flamePoint = Some(-11), volumeExplosionLimit = ExplosionLimit(LFL = 1.2, UFL = 8.6 ), weightExplosionLimit = ExplosionLimit(LFL = 39, UFL = 2809), autoIgnitionTemperature = 498, temperatureClass = "T1", MESG = 0.99, explosionClass = "IIA", gasDensity = Some(3.486), molarMass = 78.11 / 1000 )
  )
}
